...
@RestController
@RequestMapping("/api/smmservico-kafka")
public class SmmservicoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SmmservicoKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public SmmservicoKafkaResource(KafkaProperties kafkaProperties) {
