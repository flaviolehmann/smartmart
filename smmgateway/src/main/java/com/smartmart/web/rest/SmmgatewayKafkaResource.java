package com.smartmart.web.rest;

import com.smartmart.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/smmgateway-kafka")
public class SmmgatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SmmgatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public SmmgatewayKafkaResource(KafkaProperties kafkaProperties) {
